...
#         print("The total run time is "+"{:.2f}".format(T1)+"s.")
#         print('The execution time of the quantum program is ' + "{:.2f}".format(T2) + "s.")
from quito_coverage import quito
# /home/xinyi/quito/ex3/SWAP.py
# quito("/Users/xinyi/Documents/NordIQuEst/quito-main/test/configuration.ini")
# quito("/Users/xinyi/PycharmProjects/Quito/quito/ex3/as.ini")
quito("/home/xinyi/quito_gpu/program/as.ini")
